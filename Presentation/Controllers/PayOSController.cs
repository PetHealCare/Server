    ...
    public class PayOSController : ControllerBase
    {
        ...
        public async Task<IActionResult> Checkout([FromBody] CreatePaymentLinkRequest request)
        {
            try
            {
                ...
                PaymentData paymentData = new PaymentData(orderCode, Convert.ToInt32(payment.Amount * 1000),  "Thanh Toán Payment"+ payment.PaymentId, items, request.cancelUrl, request.returnUrl);
